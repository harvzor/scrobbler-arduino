# https://github.com/wmdscjhdpy/micropython-EsayMenu/blob/master/menu.py
...
class menu:
    def __init__(self,graphics,display,x,y,w,h):
        '''
    ...
    def initText(self,TextList,offset=0,hightlightnum=0):
        ...
        '''
        self.graphics.fill_rect(self.menux,self.menuy,self.menuw,self.menuh,0) #clear old menu
    ...
    def moveHighLight(self,num):
        ...
        '''
        self.graphics.rect(self.menux, self.menuy+self.hightlightnum*10, self.menuw, 10,0) #clear old rect
        self.hightlightnum=num 
        self.graphics.rect(self.menux, self.menuy+self.hightlightnum*10, self.menuw, 10,1) #set new rect
    def moveDown(self):
        '''
        User function.
